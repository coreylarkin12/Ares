...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        public Dictionary<string, int> RobPeterToPayPaul(Dictionary<string, int> peterPaul)
        {
            ...
            peterPaul.TryGetValue("Peter", out int petey);
            peterPaul.TryGetValue("Paul", out int pauley);

            if(petey > 0 && pauley < 1000)
            {
                peterPaul["Paul"] = pauley + (petey / 2);
                peterPaul["Peter"] = petey / 2;
            }
